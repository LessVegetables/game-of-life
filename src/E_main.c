...
9. add support for the different export file types (conwaylife.com)
10. add a bunch of "standaerd" thingf from conwaylife.com
*/
...
• camera zooms in/out in where the cursor is pointing with the scroll wheel (last part is to be implemented)
*/
...
int main()
{
    ...
    int gameScreenUponRequest;          // Self explanatory*; also doubles as a flag to request window to exit; *not really: gamescreenUponEXIT_request
